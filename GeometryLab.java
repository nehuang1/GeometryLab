public class GeometryLab {
    ...
    public int cylVol (int r, int h) {
        return 3.14 * r * r * h;
    }
    public int sphereVol (int r) {
        return 4/3 * 3.14 * r * r * r;
    }
    public int coneVol (int r, int h) {
        return 1/3 * 3.14 * r * r * h;
    }
    public int sphereSurfArea (int r) {
        return 4 * 3.14 * r * r;
    }    
    public int cylSurfArea (int r, int h) {
        return 2 * 3.14 * r * h + 2 * 3.14 * r * r;
    }
    public int PrismSurfArea (int b, int h, int w) {
